  ...
  render() {
    return (
      <div>
        ...
        <p>
          Utkucan Yıldırım built the Web3RTC app as a Freemium app. This SERVICE
          is provided by Utkucan Yıldırım at no cost and is intended for use as
          is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Web3RTC unless otherwise
        ...
        <p>This policy is effective as of 2023-03-08</p>{" "}
        <p>
          <strong>Contact Us</strong>
        </p>{" "}
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at the.web3rtc@gmail.com.
        </p>{" "}
        <p>
